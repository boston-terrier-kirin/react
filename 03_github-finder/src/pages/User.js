...
function User() {
  const { loading, user, getUser, repos, getUserRepos } =
    useContext(GithubContext);

  // POINT：useParams, react-router-v6では、matchではなく、useParamsを使う。
  ...
  return (
    <>
      <div className="w-full max-auto log:w-10/12">
        <div className="mb-4">
          ...
          <div className="col-span-2">
            <div className="mb-6">
              ...
              <div className="mt-4 card-actions">
                <a
                  href={html_url}
                  // POINT：target=_blank + noreferrer
                  target="_blank"
                  rel="noreferrer"
